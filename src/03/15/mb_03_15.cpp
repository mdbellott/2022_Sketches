...
void mb_03_15::drawFBO(){
    ...
    for (float j=0; j<m; j+=1.0) {
        for (float i=0; i<n; i+=1.0) {
            ...
            ofDrawCircle(pos[j][i].x, y, rad/2);
//            ofNoFill();
//            ofDrawBox(pos[j][i].x, y, 0, 20, 20, 20);
...
//--------------------------------------------------------------
void mb_03_15::keyPressed(int key){

}

//--------------------------------------------------------------
void mb_03_15::keyReleased(int key){

}

//--------------------------------------------------------------
void mb_03_15::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void mb_03_15::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_15::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_15::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_15::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void mb_03_15::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void mb_03_15::windowResized(int w, int h){

}

//--------------------------------------------------------------
void mb_03_15::gotMessage(ofMessage msg){

}

//--------------------------------------------------------------
void mb_03_15::dragEvent(ofDragInfo dragInfo){
