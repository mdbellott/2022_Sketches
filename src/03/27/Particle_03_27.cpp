#include "Particle_03_27.h"

Particle_03_27::Particle_03_27() {
    points = NULL;
}

void Particle_03_27::setPoints( vector <glm::vec3> * p ){
    points = p;
}

void Particle_03_27::reset() {
...
void Particle_03_27::draw(ofColor color) {
    ofSetColor(color);
    ofDrawCircle(pos.x, pos.y, scale * 8);
}
