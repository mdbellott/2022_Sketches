...
//--------------------------------------------------------------
void mb_03_10::setup(){
    gradient.addColor(ofColor(235, 193, 79));       // EBC14F
    gradient.addColor(ofColor(228, 72, 56));        // E44838
...
//--------------------------------------------------------------
void mb_03_10::keyPressed(int key){

}

//--------------------------------------------------------------
void mb_03_10::keyReleased(int key){

}

//--------------------------------------------------------------
void mb_03_10::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void mb_03_10::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_10::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_10::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_10::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void mb_03_10::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void mb_03_10::windowResized(int w, int h){

}

//--------------------------------------------------------------
void mb_03_10::gotMessage(ofMessage msg){

}

//--------------------------------------------------------------
void mb_03_10::dragEvent(ofDragInfo dragInfo){
