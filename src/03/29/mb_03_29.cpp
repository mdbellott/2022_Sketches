...
//--------------------------------------------------------------
void mb_03_29::setup(){
    gradient.addColor(ofColor(236, 207, 168));      // ECCFA8
    gradient.addColor(ofColor(228, 76, 251));       // E44EFB
    gradient.addColor(ofColor(212, 76, 92));        // D44C5C
...
//--------------------------------------------------------------
void mb_03_29::keyPressed(int key){

}

//--------------------------------------------------------------
void mb_03_29::keyReleased(int key){

}

//--------------------------------------------------------------
void mb_03_29::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void mb_03_29::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_29::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_29::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_29::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void mb_03_29::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void mb_03_29::windowResized(int w, int h){

}

//--------------------------------------------------------------
void mb_03_29::gotMessage(ofMessage msg){

}

//--------------------------------------------------------------
void mb_03_29::dragEvent(ofDragInfo dragInfo){
