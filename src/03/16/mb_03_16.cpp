...
//--------------------------------------------------------------
void mb_03_16::keyPressed(int key){

}

//--------------------------------------------------------------
void mb_03_16::keyReleased(int key){

}

//--------------------------------------------------------------
void mb_03_16::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void mb_03_16::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_16::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_16::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_03_16::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void mb_03_16::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void mb_03_16::windowResized(int w, int h){

}

//--------------------------------------------------------------
void mb_03_16::gotMessage(ofMessage msg){

}

//--------------------------------------------------------------
void mb_03_16::dragEvent(ofDragInfo dragInfo){
