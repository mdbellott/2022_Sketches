...
void mb_07_27::setup(){
    ...
    // Gradient
    gradient.addColor(ofColor(244, 190, 138));          // F4BE8A
...
//--------------------------------------------------------------
void mb_07_27::keyPressed(int key){

}

//--------------------------------------------------------------
void mb_07_27::keyReleased(int key){

}

//--------------------------------------------------------------
void mb_07_27::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void mb_07_27::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_07_27::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_07_27::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void mb_07_27::mouseEntered(int x, int y){

}

//--------------------------------------------------------------
void mb_07_27::mouseExited(int x, int y){

}

//--------------------------------------------------------------
void mb_07_27::windowResized(int w, int h){

}

//--------------------------------------------------------------
void mb_07_27::gotMessage(ofMessage msg){

}

//--------------------------------------------------------------
void mb_07_27::dragEvent(ofDragInfo dragInfo){
